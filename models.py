...
class Question(BaseModel):
    ...
    correct_option: list[str] = Field(description="The correct answer from the options list")
    correct_option_index: list[int] = Field(description="The indexes of the correct answer in the options list")    
